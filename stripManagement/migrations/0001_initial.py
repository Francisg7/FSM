# Generated by Django 4.0.5 on 2022-07-06 05:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.IntegerField(null=True, validators=[django.core.validators.RegexValidator('^\\d{1,10}$')])),
                ('role', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'AIM'), (2, 'TOWER'), (3, 'CU')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flight_plan', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='stripManagement.flightplan')),
                ('users', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'strip',
